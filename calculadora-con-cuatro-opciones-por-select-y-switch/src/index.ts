...
btnEnv.addEventListener("click", () => {
  ...
  switch (operacion) { // Evalua la variable operacion (Las opciones dentro del primero input).
    ...
    default: // Si el caso no es ninguna de los anteriores, (funciona como un else).
